...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{esempioFuzzy}
...
Un c-semianello pesato ha valori nell'insieme dei numeri naturali.
...
ordinamento, attraverso i multi-criteria problems.
...
la preferenza. Si usano due c-semianelli: quello fuzzy e quello pesato.
